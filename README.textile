...
ul.
  li. git clone git://github.com/edspencer/Ext.ux.Exporter.git
  li. Download from http://github.com/edspencer/Ext.ux.Exporter/zipball/master
  li. Copy/paste Exporter-all.js from http://github.com/edspencer/Ext.ux.Exporter/blob/master/Exporter-all.js
